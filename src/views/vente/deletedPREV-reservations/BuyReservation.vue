            ...
            <div class="bg-black mt-3 p-3 rounded-sm mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                        ...
                        class="form-control border border-dark px-[4rem]" disabled>
                </div>
            </div>
...
{{ this.clientSelected.current_remboursement_amount }}
...
export default defineComponent({
    ...
    methods: {
        ...
        //    else if (((this.clientSelected.current_remboursement_amount) < (this.localReservation.total_prise_en_charge)) ) {
        //         this.$toast.add({
        //             severity: 'warn',
        //             summary: 'Oups !',
