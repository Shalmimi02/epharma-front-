<template>
    ...
    <div v-if="inventaire_created">
        ...
        <AsdecodeTable useSearch :key="key"
            :url="'/api/' + table + '?inventaire_id=' + inventaire.id + '&show_diff_only=' + showDiffOnly + '&rayon_libelle=' + this.dialogRef.data.libelle"
            ...
            <template #header_action_btns>
                ...
                <button class="btn btn-danger ml-auto" @click="updateInventaire('Annulé')">
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            form: {
                type: 'Partiel',
                rayon_id: this.dialogRef.data.id,
                rayon: this.dialogRef.data.libelle
            }
        }
    },
    mounted() {
    ...
    methods: {
        ...
        openShowModal(objData) {
            this.$dialog.open(EditInventairePartiel, {
                props: {
